...
class ShowroomIndex(object):
    def __init__(self, index_directory: str, session: requests.Session=None, record_all: bool=False):
        self.room_dict = {}
    ...
    def find_room(self, room_id=None, room_url=None, room_name=None):
        if room_id:
            try:
                return self.room_dict[room_id]
            except KeyError:
            ...
            try:
                ...
                index_logger.debug("Failed to find Room URL {}".format(room_url))
                return None
                # TODO: support find by name
